            ...
            <div className={styles.information}>
                ...
                <div className={styles.columnImage}>
                    ...
                    <div className={styles.columnArticle}>
                        <p>{t.grodno.textAll3}</p>
                    </div>
                </div>
                <p>{t.grodno.textAll1}</p>
                <div className={styles.columnImage}>
                    <div className={styles.image}>
                    ...
                    <div className={styles.columnArticle}>
                        <p>{t.grodno.textAll2}</p>
                    </div>
                </div>
                <p>{t.grodno.textAll4}</p>
                <div className={styles.columnImage}>
                    <div className={styles.image}>
                        <img
                            className={styles.novogrudok}
                            src={'/novogrudok.jpg'}
                            alt="Novogrudok"
                        />
